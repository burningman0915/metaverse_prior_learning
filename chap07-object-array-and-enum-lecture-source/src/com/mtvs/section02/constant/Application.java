package com.mtvs.section02.constant;
...
public class Application {
	...
	public static void main(String[] args) {
		 ...
		 * BACKEND_JAVA = 0;
		 * BACKEND_ORACLE = 1;
		 * BACKEND_JAVASCRIPT = 2;
		 * BACKEND_JDBC = 3;
		 * 
		 * FRONTEND_HTML = 0;
		 * FRONTEND_CSS = 1;
		 * FRONTEND_JAVASCRIPT = 2;
		 */
		...
		/* 4. 같은 그룹에 속한 상수들을 순회(반복문 사용)할 수 없다. (전체 상수의 갯수 확인도 불가능함) */
		
		/* 5. 타입 안전을 보장할 수 없다. (정수를 사용하기 떄문) */
		printSubject(Subjects.ORACLE);
		printSubject(2);		//대충 아무 숫자나 넣어도 에러가 발생하지 않음(과목만 넣어야 하는데, 타입 보장 안됨, 숫자만 넣다보면 실수할 여지도 많고 가독성도 좋지 않다.)
	}
	...
	/* 비슷한 내용을 Enum Type 을 이용해서 해결해보자 */
